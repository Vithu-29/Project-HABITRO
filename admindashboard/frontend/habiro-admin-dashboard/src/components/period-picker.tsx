...
export function PeriodPicker<TItem extends string>({
  ...
  {getSelectedValue(searchParams.get(PARAM_KEY), sectionKey) || "Time Period"}
</span>
...
// Helper function to get the selected value for a sectionKey
function getSelectedValue(selectedTimeFrame: string | null, sectionKey: string): string | undefined {
  if (!selectedTimeFrame) return undefined;
  const pairs = selectedTimeFrame.split(",");
