...
urlpatterns = [
    ...
    path('api/coins/balance/', get_coin_balance, name='coin_balance'),
    path('api/coins/add/', add_coins, name='add_coins'),
    path('api/coins/deduct/', deduct_coins, name='deduct_coins'),
